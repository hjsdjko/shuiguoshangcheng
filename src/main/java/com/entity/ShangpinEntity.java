...
public class ShangpinEntity<T> implements Serializable {
	...
	@DateTimeFormat
    @TableField(value = "shangpin_time")

    private Date shangpinTime;
    ...
    public void setShangpinTime(Date shangpinTime) {
        this.shangpinTime = shangpinTime;
    }
    /**
	 * 设置：是否上架
	 */
